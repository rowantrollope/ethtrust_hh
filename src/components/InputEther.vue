...
<div class="sm:flex items-center space-x-2">                    
    ...
    <div class="p-1 text-left shrink-0 sm:text-center sm:space-x-2">
        ...
        <input class="text-base sm:w-32 w-full px-3 py-2 pl-10 rounded-md focus:ring-indigo-500 focus:border-indigo-500 border-gray-300 placeholder-gray-300"
                type="number" 
                placeholder="ETH"
                v-model="eth" 
        />
