<template>
  <div class="min-h-screen bg-white">
    ...
    <main>
      <!-- Header -->
      <div class="py-10 bg-gray-50 sm:py-15">
        <div class="max-w-md mx-auto pl-4 pr-8 sm:max-w-lg sm:px-6 lg:max-w-7xl lg:px-8">
          ...
          <p class="mt-6 max-w-3xl mx-auto text-xl leading-normal text-gray-500 text-center">
            You can connect with us through Discord, by email or by phone.  We're looking forward to hearing from you.
          </p>
        </div>
      </div>
      ...
      <div class="relative bg-white">
        ...
        <div class="relative py-10 px-4 sm:py-12 sm:px-6 lg:px-8 lg:max-w-7xl lg:mx-auto lg:py-32 lg:grid lg:grid-cols-2">
          <div class="lg:pr-8">
            <div class="max-w-md mx-auto sm:max-w-lg lg:mx-0">
              ...
              <p class="mt-4 text-lg text-gray-500 sm:mt-3">
                Send us a message using the form opposite, or email us at support@safetrust.io
              </p>
      ...
      <div class="bg-black">
        <div class="max-w-md mx-auto text-center py-16 px-4 sm:max-w-2xl sm:py-24 sm:px-6 lg:px-8 lg:py-32">
          <h2 class="text-3xl font-extrabold sm:text-4xl">
            ...
            <span class="block text-grape-500">We’re hiring.</span>
          </h2>
